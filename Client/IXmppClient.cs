...
namespace Sharp.Xmpp.Client
{
    public interface IXmppClient : IDisposable
    {
        ...
        /// <exception cref="ObjectDisposedException">The XmppClient object has been
        /// disposed.</exception>
        string InitiateFileTransfer(Jid to, string path, string description = null, Action<bool, FileTransfer> cb = null);
        ...
        void SetActivity(GeneralActivity activity, SpecificActivity specific = SpecificActivity.Other, string description = null);
        ...
        void SetTune(string title = null, string artist = null, string track = null, int length = 0, int rating = 0, string source = null, string uri = null);
